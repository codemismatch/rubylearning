...
Our Ruby curriculum now lives in one cohesive guide instead of scattered blog posts. Head over to the [Ruby tutorials](/courses/ruby-basics/#chapter-1) page to begin at Chapter&nbsp;1, meet Ruby in the console, and follow the chapters in order.
...
When you&rsquo;re ready, jump straight into [Chapter&nbsp;1: Meet Ruby](/courses/ruby-basics/#chapter-1). Keep the [resources page](/pages/resources/) handy for reference links, and explore the [blog](/blog/) for fresh Ruby and Rails articles.
